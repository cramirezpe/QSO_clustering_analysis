...
output_path = Path(os.environ['sc']) / 'QSO_clustering_analysis' / 'CoLoRe_boxes' / 'high_3x2_600_bias2'
output_path.mkdir(exist_ok=True)
colore_path = Path('/global/u2/c/cramirez/Codes/CoLoRe/1.0_bias2/CoLoRe')

...
for bias in biases:
    output_path = Path(os.environ['sc']) / 'QSO_clustering_analysis' / 'CoLoRe_boxes' / f'high_3x2_600{bias}'
...
for CoLoRe_box in ('high_3x2_600', 'high_3x2_600_bias2', 'high_3x2_600_bias3'):
    ...
    output_predir = basedir / 'corrf_from_cat_full' / CoLoRe_box / f'nside_{nside}' / _rsd_string / f'{rangemin}_{rangemax}_{N_bins}' / f'{binmin}_{binmax}' / '0'
